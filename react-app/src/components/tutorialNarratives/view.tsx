...
export default class TutoriaNarratives extends React.Component<Props, State> {
    ...
    renderNarratives() {
        ...
        return <div className="LayoutTable" data-testid="TutorialNarratives-table">
            {rows}
        </div>;
    }

    render() {
        return this.renderNarratives();
    }
}
